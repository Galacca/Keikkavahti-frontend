...
import {
  AttendingGigsCard,
  InterestedGigsCard,
} from "../components/myGigs/MyGigsCard";
      ...
      <VStack>
        ...
        >
          {myFriends.friendsList.map((f) => (
            //This needs to be a div (Box in ChakraUI's case), a react fragment will give a warning since you cant key a fragment
            <Box key={f.friend.name + "Box"}>
              <Center>
                <Text mb={3} fontWeight={700}>
                  {f.friend.name + "'s activity"}
                </Text>
              </Center>
              ...
              <Center>
                ...
                >
                  <Text borderBottom={"1px"} ml={3} mb={2} fontWeight={700}>
                    Attending
                  </Text>
                  {f.friend.gigs.attending.map((a: SimplifiedGig) => (
                    <AttendingGigsCard
                      id={a.id}
                      date={a.date}
                      bands={a.bands}
              ...
              <Center>
                ...
                >
                  ...
                  {f.friend.gigs.interested.map((a: SimplifiedGig) => (
                    <InterestedGigsCard
                      id={a.id}
                      date={a.date}
                      bands={a.bands}
